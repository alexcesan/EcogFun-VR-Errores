...
public class PiechartController : MonoBehaviour {
    ...
    void Start() {
        ...
        if (pieChart.name == "piechart_1") {
            ...
            textCounter[0].text = "Correctas: " + counts[0].ToString();
            textCounter[1].text = "Comisión: " + counts[1].ToString();
            textCounter[2].text = "Orden: " + counts[2].ToString();
            textCounter[3].text = "Normas: " + counts[3].ToString();
            textCounter[4].text = "Omisión: " + counts[4].ToString();
            textCounter[5].text = "Repetición: " + counts[5].ToString();
            ...
            // Textos que muestran el conteo de los eventos.
            textCounter[0].text = "Aciertos: " + counts[0].ToString();
            textCounter[1].text = "Fallos: " + counts[1].ToString();
    ...
    void Update() {
        ...
        for(int i = 0; i < imagesPieChart.Length; i++) {
            ...
            //imagesPieChart[i].fillAmount = Mathf.Min(currentFillAmount + 0.001f, listPercentage[i]); // Versión 2.
        }
