...
public class SceneInitializer : MonoBehaviour
{
    ...
    void Start() {
        ...
        video1Path = Path.Combine(basePath, "video_vr.mp4");
        video2Path = Path.Combine(basePath, "webcam.mp4");
    ...
    private void LoadResources() {
        ...
        } else { Debug.LogWarning($"El archivo JSON no existe en la ruta: {jsonPath}"); }
